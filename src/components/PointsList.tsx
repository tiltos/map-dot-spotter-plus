  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tabs defaultValue="points" className="w-full flex-1">
          <div
            className={`${
              !isMobile
          ...
          <TabsContent
            value="points"
            className={`flex-1 flex flex-col ${isMobile ? "mt-[80px]" : ""}`}
          >
            ...
            <ScrollArea className={`flex-1 ${isMobile ? "h-[calc(100vh-3rem-175px)]" : " h-[calc(100vh-3rem-175px-53px)]" }`}>
          ...
          <TabsContent value="story" className="p-4 flex-1 ">
            <ScrollArea className="flex-1 overflow-auto h-[calc(100vh-3rem-175px)]">
              ...
              <div className="text-sm">
                ...
                <ol className="list-disc pl-5">
                  ...
                  <li>
                    ...
                    (free browser-based Photoshop clone) to add labeling,
                    grading and visual refinement
                  </li>
                </ol>
                <p className="mt-4 mb-4">
